...
If you think an instance has been unfairly blocked, please contact us [@ordnung](https://chaos.social/@ordnung) or via
...
We do not make moderation decisions on individual users public – we'll write more about our reasons in our moderation
guidelines at a later point. The tl;dr is that listing suspended or silenced users invites terrible behaviour on all
sides. By blocking a user, we intend to stop them from harming our users or our instance, we do *not* need to incite
...
| beta.mstdn.cf               | Twitter crossposter|
...
| youjo.love                  | Lolicon, direct link to pedo.school |
